 ...
 * @param query - Search query (e.g., "AI", "blockchain", "cloud computing") - used for fallback
 * @param sortBy - Sort order: "relevancy", "popularity", or "publishedAt"
 * @param pageSize - Number of articles to fetch (default: 20, max: 100)
