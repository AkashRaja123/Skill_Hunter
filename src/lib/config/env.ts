...
const envSchema = z.object({
  ...
  OPENROUTER_FALLBACK_MODEL: z.string().default("nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free"),
...
export const env = {
  ...
  openRouterFallbackModel: parsed.data.OPENROUTER_FALLBACK_MODEL,
